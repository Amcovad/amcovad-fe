    ...
    <div className="bg-secondary-25 px-14 py-16 lg:py-20 ">
      <div>
        <div className="mt-2  avatar-group text-center">
          <div className="relative z-20 inline-flex items-center justify-center w-12 h-12 lg:w-14 lg:h-14 -ml-4  transition-all duration-200 border-2 border-neutral-white border-solid rounded-full ease-soft-in-out text-size-xs hover:z-40">
            <Image
          ...
          <div className="relative z-30 inline-flex justify-center w-14 h-14 lg:w-16 lg:h-16 -ml-4  transition-all duration-200 border-2 border-neutral-white border-solid rounded-full ease-soft-in-out text-size-xs hover:z-30">
            <Image
          ...
          <div className="relative z-20 inline-flex items-center justify-center w-12 h-12 lg:w-14 lg:h-14 -ml-4  transition-all duration-200 border-2 border-neutral-white border-solid rounded-full ease-soft-in-out text-size-xs hover:z-30">
            <Image
        ...
        <div className="text-center">
          ...
          <Button
            className="my-3 font-medium text-base md:text-xl font-Inter text-neutral-white capitalize py-3.5 px-7"
            size="xl"
          >
            Contact Us Now
          </Button>
